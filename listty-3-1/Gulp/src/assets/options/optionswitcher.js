			...
			<div class="tho-option-switcher">
				<div class="tho-option-switcher-btn tho-icon-option">
					...
					<div class="tho-option-swticher-body">
						...
						<ul class="list-unstyled tho-list-unstyled tho-color-options">
							<li class="theme-default theme-active" data-color="style" data-logo="default-logo"></li>
							<li class="theme-color1" data-color="color1" data-logo="logo1"></li>
							<li class="theme-color2" data-color="color2" data-logo="logo2"></li>
							<li class="theme-color3" data-color="color3" data-logo="logo3"></li>
							<li class="theme-color4" data-color="color4" data-logo="logo4"></li>
						</ul>
						...
						<div class="tho-bg-patern">
							...
							<ul class="list-unstyled tho-list-unstyled">
...
var setColor = function (color) {
    ...
    jQuery('body').removeClass('boxed default pattern-01 pattern-02 pattern-03 pattern-04');
		jQuery('.tho-bg-patern').css({'display':'none'});
	});
	...
	jQuery('.tho-bg-patern li.pattern-default').click(function () {
		...
		.removeClass('pattern-01 pattern-02 pattern-03 pattern-04');
	});
	jQuery('.tho-bg-patern li.pattern1').click(function () {
		...
		.removeClass('default pattern-02 pattern-03 pattern-04');
	});
	jQuery('.tho-bg-patern li.pattern2').click(function () {
		...
		.removeClass('default pattern-01 pattern-03 pattern-04');
	});
	jQuery('.tho-bg-patern li.pattern3').click(function () {
		...
		.removeClass('default pattern-01 pattern-02 pattern-04');
	});
	jQuery('.tho-bg-patern li.pattern4').click(function () {
		...
		.removeClass('default pattern-01 pattern-02 pattern-03');
	});
	jQuery('.tho-bg-patern li.pattern5').click(function () {
		...
		.removeClass('default pattern-01 pattern-02 pattern-03 pattern-04');
	});
...
ltr.click(function() {
	...
	jQuery("#option_style").attr("href", "assets/css/style.css");
...
rtl.click(function() {
  ...
  jQuery("#option_style").attr("href", "assets/css/style.rtl.css");
});

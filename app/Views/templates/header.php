...
<html lang="en">
  ...
  <head>
    ...
    <title>Admin Listing - Listty</title>
            ...
            <div id="menuzord" class="menuzord menuzord-responsive">
              ...
              <div class="menu-right menu-left">
                <div class="notification">
                  <a class="dropdown-toggle" href="javascript:void(0)" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true"
                    aria-expanded="false">
                ...
                <div class="avatar">
                  <a class="dropdown-toggle" href="javascript:void(0)" role="button" data-bs-toggle="dropdown" aria-haspopup="true" data-bs-display="static"
                    aria-expanded="false">
                    <img class="avatar-img" src="assets/img/user/user-1.jpg" alt="Image">
                    <span class="avatar-name">Abriel
                      <span class="small">Admin</span>
                    </span>
                  </a>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="d-flex flex-wrap align-items-center" href="profile-site-admin.html">
                    ...
                    <li>
                      <a class="d-flex flex-wrap align-items-center" href="javascript:void(0)">
